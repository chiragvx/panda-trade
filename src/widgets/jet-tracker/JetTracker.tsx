    ...
    <div style={{ height: '100%', display: 'flex', flexDirection: 'column', background: COLOR.bg.base, fontFamily: TYPE.family.mono }}>
      {alertJet && (
        <div style={{ padding: '8px 12px', background: `${COLOR.semantic.warning}20`, borderBottom: `1px solid ${COLOR.semantic.warning}40`, display: 'flex', alignItems: 'center', gap: '12px' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column' }}>
            <span style={{ fontSize: '8px', fontWeight: TYPE.weight.bold, color: COLOR.semantic.warning, textTransform: 'uppercase' }}>AIRBORNE_JET_DETECTED</span>
      ...
      <div style={{ flex: 1, overflowY: 'auto' }} className="custom-scrollbar">
        ...
        {trackedJets.length === 0 ? (
          <div style={{ padding: '24px', textAlign: 'center', color: COLOR.text.muted, fontSize: '10px', textTransform: 'uppercase' }}>NO JET TRACKING DATA</div>
        ) : (
