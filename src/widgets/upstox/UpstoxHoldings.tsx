...
import { useMockHoldings } from '../../mock/hooks';
        ...
        <div style={{ display: 'flex', flexDirection: 'column', height: '100%', background: COLOR.bg.base }}>
            ...
            <div style={{ flex: 1, overflow: 'auto' }} className="custom-scrollbar">
                <table style={{ width: '100%', borderCollapse: 'collapse', fontFamily: TYPE.family.mono }}>
                    <thead>
                        <tr style={{ 
                            position: 'sticky', top: 0, background: COLOR.bg.surface, 
                            borderBottom: BORDER.standard, zIndex: 10 
                        }}>
                    ...
                    <tbody>
                        {holdings.map((h, i) => (
                            <tr key={i} style={{ 
                                ...
                                <td style={{ ...tdStyle, color: '#fff' }}>{h.marketValue.toLocaleString('en-IN')}</td>
            ...
            <div style={{ 
                padding: '6px 12px', background: COLOR.bg.surface, borderTop: BORDER.standard,
...
const thStyle: React.CSSProperties = {
    textAlign: 'left', padding: '0 12px', fontSize: '9px', fontWeight: '900',
    color: COLOR.text.muted, height: '24px', letterSpacing: '0.05em'
};

const tdStyle: React.CSSProperties = {
    padding: '0 12px', fontSize: '11px', color: COLOR.text.secondary
};
